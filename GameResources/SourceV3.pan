...
currentBytes=0
byteSize=""
gettext "What's your name?",playerName
yesno "Your name is "+playerName+"?"
if clipboard()="No"
rtn
endif
...
define currentSize,0
define byteSize,0
define nameList,"New Player"


//PlayerSelection
superchoicedialog nameList, nameChoice, {caption="Choose your player")}

//creates a player
if arraysize(nameList,¶)<2 or nameChoice="New Player"
call .addPlayer
