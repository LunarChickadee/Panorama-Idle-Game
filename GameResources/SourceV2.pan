...
global currentBytes, gameDict, byteSize,name1,totalBytes
permanent name
...
gettext "What's your name?",name1
name=name1
field Inventory
copycell
pastecell
...
CurrentSize=0
LifetimeBytes=0
TotalMemory=0 ///set this as an array or dict value and have the player "install" ram?
...
___ PROCEDURE clearName/1 ______________________________________________________
name=""
___ ENDPROCEDURE clearName/1 ___________________________________________________
